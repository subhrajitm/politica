...
export default function EditPartyPage() {
  ...
  const loadParty = async () => {
    try {
      ...
      const party = await PoliticalPartyService.getPartyById(partyId);
      if (party) {
        setFormData(party);
      } else {
        toast({
      ...
      toast({
        title: 'Error',
        description: 'Failed to load political party',
        variant: 'destructive',
      });
      router.push('/admin/parties');
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      await PoliticalPartyService.updateParty(partyId, formData);
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Update political party information
          </p>
        </div>
      </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => handleInputChange('ideology', value)}
                >
                  <SelectTrigger>
